/*
  ...
  1. Changes
    - Add suspended role to profiles
    - Update RLS policies for suspended users
    - Add trigger for handling suspension state
*/
...
-- Recreate message policies with suspension checks
...
-- Add policy to ensure only admin can suspend accounts
