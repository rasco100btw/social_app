/*
  # Add Poll Functionality to Posts
  
  1. New Tables
    - `polls` - For storing poll questions
    - `poll_options` - For storing poll choices
    - `poll_votes` - For tracking user votes
  
  2. Changes to Existing Tables
    - Add `is_poll` and `poll_data` columns to posts table
