/*
  ...
  1. Changes
    - Modify student_groups policies to only allow class leaders to create groups
    - Add policy for admins to delete any group
    - Remove create group button for non-class leaders
  
  2. Security
    - Only class leaders can create new groups
    - Admins can delete any group regardless of who created it
    - Regular students can only view groups, not create them
*/
